window.GAME_DATA = {
  ...
  balance: {
    ...
    career: {
      ...
      promotion:{id:'promotion',actionKey:'promotion',ap:1,minPerformance:65,minBossQuality:45,promotionPerformance:55,raiseBaseChance:0.12,performanceDivisor:180,socialDivisor:700,bossDivisor:900,raiseRange:[1.05,1.11]}
    },
    finance: {
      save:{amount:500,requirements:[{type:'cashMin',value:500}]}, withdraw:{amount:500}, loan:{amount:5000,creditMin:560,creditPenalty:12,requirements:[{type:'ageMin',value:18},{type:'creditMin',value:560},{type:'notJailed'}]},
      debtPayment:{amount:1000,creditGain:8,options:[1000,10000],percentOption:0.25}, invest:{amount:1000,requirements:[{type:'cashMin',value:1000}]}, bankruptcy:{credit:300,happiness:-12,stress:12}
    },
    relationships: {
  ...
  jobs: {
    fastfood:{name:'Fast Food Worker',track:'Service',salary:22000,minAge:16,edu:'None',intel:0,social:0,skill:null,skillMin:0,next:'retail',requirements:[{type:'ageMin',value:16},{type:'notJailed'}]},
    retail:{name:'Retail Associate',track:'Service',salary:28000,minAge:16,edu:'None',intel:0,social:35,skill:'communication',skillMin:20,next:'supervisor',requirements:[{type:'ageMin',value:16},{type:'socialMin',value:35},{type:'skillMin',skill:'communication',value:20},{type:'notJailed'}]},
    supervisor:{name:'Retail Supervisor',track:'Service',salary:42000,minAge:19,edu:'High School',intel:35,social:50,skill:'communication',skillMin:40,next:'manager',requirements:[{type:'ageMin',value:19},{type:'educationMin',value:'High School'},{type:'intelligenceMin',value:35},{type:'socialMin',value:50},{type:'skillMin',skill:'communication',value:40},{type:'notJailed'}]},
    manager:{name:'Operations Manager',track:'Operations',salary:105000,minAge:24,edu:'College',intel:60,social:70,skill:'business',skillMin:55,next:'director',requirements:[{type:'ageMin',value:24},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:60},{type:'socialMin',value:70},{type:'skillMin',skill:'business',value:55},{type:'notJailed'}]},
    director:{name:'Operations Director',track:'Operations',salary:145000,minAge:30,edu:'College',intel:68,social:75,skill:'business',skillMin:70,next:null,requirements:[{type:'ageMin',value:30},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:68},{type:'socialMin',value:75},{type:'skillMin',skill:'business',value:70},{type:'notJailed'}]},
    ...
    industrialtech:{name:'Industrial Technician',track:'Industrial',salary:56000,minAge:20,edu:'High School',intel:45,social:10,skill:'mechanical',skillMin:50,next:'electrician',requirements:[{type:'ageMin',value:20},{type:'educationMin',value:'High School'},{type:'intelligenceMin',value:45},{type:'socialMin',value:10},{type:'skillMin',skill:'mechanical',value:50},{type:'notJailed'}]},
    electrician:{name:'Electrician',track:'Industrial',salary:65000,minAge:18,edu:'Trade School',intel:45,social:0,skill:'mechanical',skillMin:55,next:'controls',requirements:[{type:'ageMin',value:18},{type:'educationMin',value:'Trade School'},{type:'intelligenceMin',value:45},{type:'skillMin',skill:'mechanical',value:55},{type:'notJailed'}]},
    controls:{name:'Controls Specialist',track:'Automation',salary:90000,minAge:21,edu:'Trade School',intel:65,social:25,skill:'mechanical',skillMin:70,next:'automation',requirements:[{type:'ageMin',value:21},{type:'educationMin',value:'Trade School'},{type:'intelligenceMin',value:65},{type:'socialMin',value:25},{type:'skillMin',skill:'mechanical',value:70},{type:'notJailed'}]},
    automation:{name:'Automation Engineer',track:'Automation',salary:105000,minAge:22,edu:'College',intel:72,social:25,skill:'technology',skillMin:70,next:'engineeringmanager',requirements:[{type:'ageMin',value:22},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:72},{type:'socialMin',value:25},{type:'skillMin',skill:'technology',value:70},{type:'notJailed'}]},
    engineeringmanager:{name:'Engineering Manager',track:'Automation',salary:135000,minAge:28,edu:'College',intel:70,social:70,skill:'communication',skillMin:65,next:null,requirements:[{type:'ageMin',value:28},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:70},{type:'socialMin',value:70},{type:'skillMin',skill:'communication',value:65},{type:'notJailed'}]},
    it:{name:'IT Support Specialist',track:'IT',salary:56000,minAge:18,edu:'High School',intel:55,social:35,skill:'technology',skillMin:45,next:'sysadmin',requirements:[{type:'ageMin',value:18},{type:'educationMin',value:'High School'},{type:'intelligenceMin',value:55},{type:'socialMin',value:35},{type:'skillMin',skill:'technology',value:45},{type:'notJailed'}]},
    sysadmin:{name:'Systems Administrator',track:'IT',salary:82000,minAge:20,edu:'College',intel:65,social:30,skill:'technology',skillMin:65,next:'networkeng',requirements:[{type:'ageMin',value:20},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:65},{type:'socialMin',value:30},{type:'skillMin',skill:'technology',value:65},{type:'notJailed'}]},
    networkeng:{name:'Network Engineer',track:'IT',salary:98000,minAge:22,edu:'College',intel:70,social:35,skill:'technology',skillMin:75,next:'itmanager',requirements:[{type:'ageMin',value:22},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:70},{type:'socialMin',value:35},{type:'skillMin',skill:'technology',value:75},{type:'notJailed'}]},
    itmanager:{name:'IT Manager',track:'IT',salary:125000,minAge:26,edu:'College',intel:65,social:70,skill:'communication',skillMin:65,next:null,requirements:[{type:'ageMin',value:26},{type:'educationMin',value:'College'},{type:'intelligenceMin',value:65},{type:'socialMin',value:70},{type:'skillMin',skill:'communication',value:65},{type:'notJailed'}]},
    doctor:{name:'Physician',track:'Medicine',salary:215000,minAge:26,edu:'Graduate',intel:85,social:45,skill:'communication',skillMin:45,next:null,requirements:[{type:'ageMin',value:26},{type:'educationMin',value:'Graduate'},{type:'intelligenceMin',value:85},{type:'socialMin',value:45},{type:'skillMin',skill:'communication',value:45},{type:'notJailed'}]}
  },
  universities: {
