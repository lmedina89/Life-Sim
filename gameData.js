window.GAME_DATA = {
  ...
  housing: {
    ...
    apartment:{name:'Apartment',price:0,annual:14000,minAge:18,owned:false,kind:'rent',utilitiesAnnual:2200},
    condo:{name:'Condo',price:120000,annual:0,minAge:18,owned:true,kind:'owned',propertyTaxRate:0.011,maintenanceRate:0.008,insuranceRate:0.004,hoaAnnual:3000,utilitiesAnnual:2400},
    house:{name:'House',price:280000,annual:0,minAge:18,owned:true,kind:'owned',propertyTaxRate:0.012,maintenanceRate:0.012,insuranceRate:0.0045,hoaAnnual:0,utilitiesAnnual:3200},
    luxury:{name:'Luxury House',price:900000,annual:0,minAge:21,owned:true,kind:'owned',propertyTaxRate:0.014,maintenanceRate:0.016,insuranceRate:0.005,hoaAnnual:0,utilitiesAnnual:7000}
  },
  lifestyles: {
  ...
  inventoryCatalog: {
    ...
    usedcar:{name:'Used Car',price:8000,type:'Vehicle',conditionLoss:12,annualCost:2800},
    newcar:{name:'New Car',price:35000,type:'Vehicle',conditionLoss:8,annualCost:4500},
    luxurycar:{name:'Luxury Car',price:95000,type:'Vehicle',conditionLoss:7,annualCost:9000},
